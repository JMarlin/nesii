...
ONTABLE:        .BYTE $01,$30,$28,$24,$20,$1E,$1D,$1C,$1C,$1C,$1C,$1C
...
OFFTABLE:       .BYTE $70,$2C,$26,$22,$1F,$1E,$1D,$1C,$1C,$1C,$1C,$1C
...
DSKNBTBL:       .BYTE $96,$97,$9A,$9B,$9D,$9E,$9F
                .BYTE $A6,$A7,$AB,$AC,$AD,$AE,$AF
                .BYTE $B2,$B3,$B4,$B5,$B6,$B7,$B9,$BA,$BB,$BC,$BD,$BE,$BF
                .BYTE $CB,$CD,$CE,$CF
                .BYTE $D3,$D6,$D7,$D9,$DA,$DB,$DC,$DD,$DE,$DF
                .BYTE $E5,$E6,$E7,$E9,$EA,$EB,$EC,$ED,$EE,$EF
                .BYTE $F2,$F3,$F4,$F5,$F6,$F7,$F9,$FA,$FB,$FC,$FD,$FE,$FF
                ...
                .BYTE $B3, $B3, $A0, $E0, $B3, $C3, $C5, $B3, $A0, $E0, $B3, $C3, $C5
                .BYTE $B3, $A0, $E0, $B3, $B3, $C5, $AA, $A0, $82, $B3, $B3, $C5
                .BYTE $AA, $A0, $82, $C5, $B3, $B3, $AA, $88, $82, $C5, $B3, $B3
                .BYTE $AA, $88, $82, $C5, $C4, $B3, $B0, $88
NDX2NIBL:                                ; ==================================
                                ...
                                ; $96-$FF are spacers
N2NOFF:= $96
                .BYTE $00,$01                     ; VALID INDICES.
                .BYTE $98,$99                     ; 2 SPACERS.
                .BYTE $02,$03                     ; VALID INDICES.
                .BYTE $9C                         ; 1 SPACER.
                .BYTE $04,$05,$06                 ; VALID INDICES.
                .BYTE $A0,$A1,$A2,$A3,$A4,$A5     ; 6 SPACERS.
                .BYTE $07,$08                     ; VALID INDICES.
                .BYTE $A8,$A9,$AA                 ; 3 SPACERS.
                .BYTE $09,$0A,$0B,$0C,$0D         ; VALID INDICES.
                .BYTE $B0,$B1                     ; 2 SPACERS.
                .BYTE $0E,$0F,$10,$11,$12,$13     ; VALID INDICES.
                .BYTE $B8                         ; 1 SPACER.
                .BYTE $14,$15,$16,$17,$18,$19,$1A ; VALID INDICES.
                .BYTE $C0,$C1,$C2,$C3,$C4,$C5     ; 6 SPACERS.
                .BYTE $C6,$C7,$C8,$C9,$CA         ; 5 SPACERS.
                .BYTE $1B                         ; VALID INDEX.
                .BYTE $CC                         ; 1 SPACER.
                .BYTE $1C,$1D,$1E                 ; VALID INDICES.
                .BYTE $D0,$D1,$D2                 ; 3 SPACERS.
                .BYTE $1F                         ; VALID INDEX.
                .BYTE $D4,$D5                     ; 2 SPACERS.
                .BYTE $20,$21                     ; VALID INDICES.
                .BYTE $D8                         ; 1 SPACER.
                .BYTE $22,$23,$24,$25,$26,$27,$28 ; VALID INDICES.
                .BYTE $E0,$E1,$E2,$E3,$E4         ; 5 SPACERS.
                .BYTE $29,$2A,$2B                 ; VALID INDICES.
                .BYTE $E8                         ; 1 SPACER.
                .BYTE $2C,$2D,$2E,$2F,$30,$31,$32 ; 7 INDICES.
                .BYTE $F0,$F1                     ; 2 SPACERS.
                .BYTE $33,$34,$35,$36,$37,$38     ; VALID INDICES.
                .BYTE $F8                         ; 1 SPACER.
                .BYTE $39,$3A,$3B,$3C,$3D,$3E,$3F ; VALID INDICES.
...
FREE1:
                ...
                .BYTE $88
                .BYTE $A5,$E8,$91,$A0,$94,$88,$96,$E8
                .BYTE $91,$A0,$94,$88,$96
                .BYTE $91,$91,$C8
                .BYTE $94,$D0,$96,$91,$91,$C8,$94,$D0
                .BYTE $96,$91,$A3,$C8,$A0,$A5,$85,$A4
